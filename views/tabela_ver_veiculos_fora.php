                    ...
                    <table  style="margin: auto; width: 90%; height: 90%;" >
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $ret=require('../controllers/obter_veiculos_fora.php');
                                $cnt=1;
                            ...
                            <tr>
                                ...
                                <a href="../controllers/recibo.php?vid=<?php echo $row['ID'];?>" style="cursor:pointer" target="_blank"><i><img src="https://img.icons8.com/plasticine/50/000000/receipt.png"/></i></a><b> &nbsp;|</b>
                                <a href="../controllers/excluir_veiculo.php?ID=<?php echo $row['ID']; ?>"><i><img src="https://img.icons8.com/plasticine/40/000000/full-trash.png"/></i></a>
                                </td>
                            </tr>
