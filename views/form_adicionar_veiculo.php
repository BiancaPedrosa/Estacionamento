  ...
  <body class="section" style="background: #45d6b2; font-family: 'Trirong', serif; ">
    ...
    <div class="container mt-4"  style=" font-family: 'Trirong', serif; background: rgba(215, 246, 236, 0.87);border-radius: 30px 30px; ">
      ...
      <div class="login">
        ...
        <form class="form" method="POST" action="../controllers/adicionar_veiculo.php">
          &nbsp;
          <img src="https://img.icons8.com/external-prettycons-lineal-color-prettycons/40/000000/external-parking-urban-vol-2-prettycons-lineal-color-prettycons-1.png"/>
            <input style="border-radius: 15px;" type="text" name="NumeroEstacionamento" value="1" required/>
          &nbsp;
          <img src="https://img.icons8.com/color/40/000000/car--v2.png"/>
          <input style="border-radius: 15px" type="text" name="Modelo" value="Modelo" required/>
          
          &nbsp;
          <img src="https://img.icons8.com/fluency/40/000000/color-palette.png"/>
          <input style="border-radius: 15px" type="text" name="Cor" value="Cor" required/>
          
          <br>&nbsp;
          <img src="https://img.icons8.com/color/40/000000/fiat.png"/>
          <input style="border-radius: 15px" type="text" name="Marca" value="Marca" required/>
          
          &nbsp;
          <img style=" height: 40px" src="..\img\placa-de-carro.png"/>
          <input style="border-radius: 15px" type="text" name="Placa" value="Placa" required/>
          
          &nbsp;
          <img src="https://img.icons8.com/fluency/40/000000/landlord.png"/>
          <input style="border-radius: 15px" type="text" name="NomeProprietario" value="Nome do Proprietário" required/>
          ...
          <input style="border-radius: 15px" type="text" name="TelefoneProprietario" value="1999999999" required/>
