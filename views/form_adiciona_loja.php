...
<html class="PT-BR" lang="">
  ...
  <body class="section" style="background: #45d6b2; font-family: 'Trirong', serif; ">
    ...
    <div class="container mt-4"  style=" font-family: 'Trirong', serif; background: rgba(215, 246, 236, 0.87);border-radius: 30px 30px; ">
      ...
      <div class="login">
        <h1 class="titulo"> <b>Cadastrar Loja</b> <img src="https://img.icons8.com/plasticine/60/000000/online-shop.png"/></h1>
       
        <form class="form" method="POST" action="../controllers/adicionar_loja.php">
          &nbsp;  &nbsp;  &nbsp; &nbsp;  
